...
//add by gaopeng   20140915
#ifdef CONFIG_VIDEO_TVP5150_A
static struct tvp5150_platform_data tvp5150a_ch1_plat = {
	.default_width = 720,
	.default_height = 480,//240
	.pixelformat = V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_UYVY,
	.freq = 27000000,
	.is_mipi = 0,
};

static struct tvp5150_platform_data tvp5150a_ch2_plat = {
	.default_width = 720,
	.default_height = 480,//240
	.pixelformat = V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_UYVY,
	.freq = 27000000,
...
static struct i2c_board_info tvp5150a_ch1_i2c_info = {
	I2C_BOARD_INFO("tvp5150a", 0xb8 >> 1),
	//I2C_BOARD_INFO("rptvp5150", 0xba >> 1),
	.platform_data = &tvp5150a_ch1_plat,
};

static struct i2c_board_info tvp5150a_ch2_i2c_info = {
	I2C_BOARD_INFO("tvp5150a", 0xb8 >> 1),
	//I2C_BOARD_INFO("rptvp5150", 0xba >> 1),
	.platform_data = &tvp5150a_ch2_plat,
};


static struct s3c_platform_camera tvp5150a_ch1 = {
	.id		= CAMERA_PAR_A,
	.type		= CAM_TYPE_ITU,
	.fmt		= ITU_601_YCBCR422_8BIT,//ITU_656_YCBCR422_8BIT,//ITU_656_YCBCR422_8BIT, 
	.order422	= CAM_ORDER422_8BIT_CBYCRY,  
	.i2c_busnum	= 7,
	.info		= &tvp5150a_ch1_i2c_info,
	.pixelformat	= V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_YVYU,//V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_YVYU
	.srclk_name	= "xusbxti",
	.clk_name	= "sclk_cam1",
	.clk_rate	= 27000000,             /* 24MHz */
	.line_length	= 720,              /* 640*480 */
	/* default resol for preview kind of thing */
	.width		= 720,
	.height		= 480,//240,//288,//240,
	.window		= {
	#if 0	
		.left   = 48,
		.top    = 12,
...
static struct s3c_platform_camera tvp5150a_ch2 = {
	.id		= CAMERA_PAR_A,
	.type		= CAM_TYPE_ITU,
	.fmt		= ITU_656_YCBCR422_8BIT,//ITU_656_YCBCR422_8BIT, 
	.order422	= CAM_ORDER422_8BIT_CBYCRY,  
	.i2c_busnum	= 7,
	.info		= &tvp5150a_ch2_i2c_info,
	.pixelformat	= V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_YVYU,//V4L2_PIX_FMT_YUYV,//V4L2_PIX_FMT_YVYU,
	.srclk_name	= "xusbxti",
	.clk_name	= "sclk_cam1",
	.clk_rate	= 27000000,             /* 24MHz */
...
//add by gaopeng   20140917
#ifdef CONFIG_VIDEO_TVP5150_B
static struct tvp5150_platform_data tvp5150b_ch1_plat = {
	.default_width = 720,
	.default_height = 480,//240
...
static struct tvp5150_platform_data tvp5150b_ch2_plat = {
	.default_width = 720,
	.default_height = 480,//240
	.pixelformat = V4L2_PIX_FMT_UYVY,
	.freq = 27000000,
...
static struct i2c_board_info tvp5150b_ch1_i2c_info = {
	I2C_BOARD_INFO("tvp5150b", 0xba >> 1),
	//I2C_BOARD_INFO("tvp5150", 0xba >> 1),
	.platform_data = &tvp5150b_ch1_plat,
};

static struct i2c_board_info tvp5150b_ch2_i2c_info = {
	I2C_BOARD_INFO("tvp5150b", 0xba >> 1),
	//I2C_BOARD_INFO("tvp5150", 0xba >> 1),
	.platform_data = &tvp5150b_ch2_plat,
};


static struct s3c_platform_camera tvp5150b_ch1 = {
	.id		= CAMERA_PAR_B,
	.type		= CAM_TYPE_ITU,
	.fmt		= ITU_656_YCBCR422_8BIT,//ITU_656_YCBCR422_8BIT, 
	.order422	= CAM_ORDER422_8BIT_CBYCRY,  
	.i2c_busnum	= 7,
	.info		= &tvp5150b_ch1_i2c_info,
...
static struct s3c_platform_camera tvp5150b_ch2 = {
	.id		= CAMERA_PAR_B,
	.type		= CAM_TYPE_ITU,
	.fmt		= ITU_656_YCBCR422_8BIT,//ITU_656_YCBCR422_8BIT, 
	.order422	= CAM_ORDER422_8BIT_CBYCRY,  
	.i2c_busnum	= 7,
	.info		= &tvp5150b_ch2_i2c_info,
	.pixelformat	= V4L2_PIX_FMT_YVYU,
	.srclk_name	= "xusbxti",
	.clk_name	= "sclk_cam1",
	.clk_rate	= 27000000,             /* 24MHz */
...
#endif
/*
#if defined(CONFIG_VIDEO_TVP5150_A)
	.default_cam	= CAMERA_PAR_A,	
#endif

#if defined(CONFIG_VIDEO_TVP5150_B)
	.default_cam	= CAMERA_PAR_B,	
#endif*/
...
#endif 
	{ ACT8847_DCDC_DUMMY, &act8847_dummy_data }, 	//for other fixed dcdc/ldo.
};
...
#include <../drivers/media/radio/si4713-i2c.h>
struct si4713_device si4713_pdata_gpio = {
	.gpio_reset = EXYNOS4212_GPV0(0),
};
 struct i2c_board_info i2c_devs0_rev0[] __initdata = {
	/*
	{
		I2C_BOARD_INFO("max77686", (0x12 >> 1)),
		.platform_data	= &exynos4_max77686_info,
	...
	{
		//I2C_BOARD_INFO("si4713", 0x11),
		//.platform_data  = &si4713_pdata_gpio,
		//I2C_BOARD_INFO("si4702", 0x10),
	},	
	
};
//wsb test for lsy
 struct i2c_board_info i2c_devs0_rev3[] __initdata = {
	/*
	{
		I2C_BOARD_INFO("max77686", (0x12 >> 1)),
		.platform_data	= &exynos4_max77686_info,
...
/*	KEY(1, 0, KEY_D), KEY(1, 1, KEY_A), KEY(1, 2, KEY_B),
	...
	KEY(0, 0, KEY_LEFT), KEY(0, 1, KEY_RIGHT), KEY(0, 2, KEY_UP),
	KEY(1, 0, KEY_DOWN), KEY(1, 1, KEY_VOLUMEUP), KEY(1, 2, KEY_VOLUMEDOWN),
	KEY(2, 0, KEY_MENU), KEY(2, 1, KEY_HOME), KEY(2, 2, KEY_ESC),
};
...
struct radio_si4713_platform_data si4713_pdata = {
	.i2c_bus = 3,
	.subdev_board_info = i2c_devs0_rev3,
};

static struct platform_device radio_si4713 = {

	.name = "radio-si4713",
	.dev = {
		.platform_data = &si4713_pdata,
	},	
};
...
#define SROM_BW  0x12570000
#define SROM_BC3  0x12570010
static void  smdk4412_dm9000_init(void)
{
	unsigned int tmp;
/*	tmp = __raw_readl(SROM_BW);
	tmp &= ~(0xF<<12);   
	tmp |= (1<<15) | (1<<14) | (1<<13) | (1<<12);   
	__raw_writel(tmp, SROM_BW);
	__raw_writel((0x0<<28)|(0x0<<24)|(0x5<<16)|(0x0<<12)|(0x0<<8)|(0x0<<4)|(0x0<<0), SROM_BC3);   
	*/
//	tmp = __raw_readl((void __iomem __force *)0x11000120);  //GPY0CON

     void __iomem	* cony0;
      void __iomem	* bw;
	void __iomem	* bc3;
	void __iomem	* gpy;
	cony0=ioremap(0x11000120, 4);
	bw=ioremap(SROM_BW, 4);
	bc3=ioremap(SROM_BC3, 4);
	...
	tmp |=  (1<<15) | (1<<14) | (1<<13) | (1<<12);   
	writel(tmp, bw);
	writel((0x1 << S5P_SROM_BCX__PMC__SHIFT) |
		     (0x9 << S5P_SROM_BCX__TACP__SHIFT) |
		     (0xc << S5P_SROM_BCX__TCAH__SHIFT) |
		     (0x1 << S5P_SROM_BCX__TCOH__SHIFT) |
		     (0x6 << S5P_SROM_BCX__TACC__SHIFT) |
		     (0x1 << S5P_SROM_BCX__TCOS__SHIFT) |
		     (0x1 << S5P_SROM_BCX__TACS__SHIFT), bc3);   
	iounmap(bw);
	iounmap(bc3);

    gpy=ioremap(0x11000120,4);
	writel(0x22222222,gpy);
	iounmap(gpy);
	
	gpy=ioremap(0x11000140,4);
	writel(0x22222222,gpy);
	iounmap(gpy);
	
	gpy=ioremap(0x11000180,4);
	writel(0x22222222,gpy);
	iounmap(gpy);
	
	gpy=ioremap(0x110001a0,4);
	writel(0x22222222,gpy);
	iounmap(gpy);
	
	gpy=ioremap(0x110001c0,4);
	writel(0x22222222,gpy);
	iounmap(gpy);
	
	gpy=ioremap(0x110001e0,4);
	writel(0x22222222,gpy);
	iounmap(gpy); 
}
...
//	smdk4x12_smsc911x_init();
	...
	/*************************LED  default	 output 0 ----ALL OFF **/
	//add by eking
#if 0	// old SCH	20120809  
		 gpio_request(EXYNOS4212_GPM4(1), "D3");
		 gpio_request(EXYNOS4212_GPM4(2), "D4");
		 gpio_request(EXYNOS4212_GPM4(3), "D6");
		 gpio_request(EXYNOS4212_GPM4(4), "D7");
...
#if 1  //new SCH 20121016A
		 gpio_request(EXYNOS4212_GPM3(0), "D3");
		 gpio_request(EXYNOS4212_GPM3(1), "D4");
		 gpio_request(EXYNOS4212_GPM2(4), "D6");
		 gpio_request(EXYNOS4212_GPM2(3), "D7");
		 
		 gpio_direction_output(EXYNOS4212_GPM3(0),0);
		 gpio_direction_output(EXYNOS4212_GPM3(1),0);
		 gpio_direction_output(EXYNOS4212_GPM2(4),0);
		 gpio_direction_output(EXYNOS4212_GPM2(3), 0);

		// s3c_gpio_cfgpin(EXYNOS4212_GPM3(0), S3C_GPIO_SFN(1));
		// s3c_gpio_cfgpin(EXYNOS4212_GPM3(1), S3C_GPIO_SFN(1));
		// s3c_gpio_cfgpin(EXYNOS4212_GPM2(4), S3C_GPIO_SFN(1));
		// s3c_gpio_cfgpin(EXYNOS4212_GPM2(3), S3C_GPIO_SFN(1));
	
		// gpio_set_value(EXYNOS4212_GPM3(0),1);
		 //gpio_set_value(EXYNOS4212_GPM3(1),1);
