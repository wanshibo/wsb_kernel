		...
		unsigned int cmd, void *arg)
{
	...
	case VIDIOC_TEST_FMT:
	{
		struct v4l2_format *f = (struct v4l2_format *)arg;
		ret = ops->vidioc_fimc_test(file,fh);
		if (ret)
		break;
	}
	case VIDIOC_S_FMT:
	{
		...
		switch (f->type) {
		case V4L2_BUF_TYPE_VIDEO_CAPTURE:
			printk("[V4L2_BUF_TYPE_VIDEO_CAPTURE]\n");
			...
			break;
		case V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE:
			printk("[V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE]\n");
			...
			break;
		case V4L2_BUF_TYPE_VIDEO_OVERLAY:
			//printk("[V4L2_BUF_TYPE_VIDEO_OVERLAY]\n");
			...
			break;
		case V4L2_BUF_TYPE_VIDEO_OUTPUT:
			//printk("[V4L2_BUF_TYPE_VIDEO_OUTPUT]\n");
			CLEAR_AFTER_FIELD(f, fmt.pix);
			v4l_print_pix_fmt(vfd, &f->fmt.pix);
			...
			break;
		case V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE:
			printk("[V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE]\n");
			CLEAR_AFTER_FIELD(f, fmt.pix_mp);
			v4l_print_pix_fmt_mplane(vfd, &f->fmt.pix_mp);
			...
			break;
		case V4L2_BUF_TYPE_VIDEO_OUTPUT_OVERLAY:
			printk("[V4L2_BUF_TYPE_VIDEO_OUTPUT_OVERLAY]\n");
			CLEAR_AFTER_FIELD(f, fmt.win);
			...
			break;
		case V4L2_BUF_TYPE_VBI_CAPTURE:
			printk("[V4L2_BUF_TYPE_VBI_CAPTURE]\n");
			CLEAR_AFTER_FIELD(f, fmt.vbi);
			if (ops->vidioc_s_fmt_vbi_cap)
				ret = ops->vidioc_s_fmt_vbi_cap(file, fh, f);
			break;
		case V4L2_BUF_TYPE_VBI_OUTPUT:
			printk("[V4L2_BUF_TYPE_VBI_OUTPUT]\n");
			CLEAR_AFTER_FIELD(f, fmt.vbi);
			if (ops->vidioc_s_fmt_vbi_out)
				ret = ops->vidioc_s_fmt_vbi_out(file, fh, f);
			break;
		case V4L2_BUF_TYPE_SLICED_VBI_CAPTURE:
			printk("[V4L2_BUF_TYPE_SLICED_VBI_CAPTURE]\n");
			...
			break;
		case V4L2_BUF_TYPE_SLICED_VBI_OUTPUT:
			printk("[V4L2_BUF_TYPE_SLICED_VBI_OUTPUT]\n");
			CLEAR_AFTER_FIELD(f, fmt.sliced);
